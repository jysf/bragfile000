...
|---|---:|---|
| Decision records | 50 | `decisions/DEC-*.md` (`insight.type: decision`) |
...
| Specs carried to ship and archived | 84 | `projects/*/specs/done/` |
| …of those, also carrying a build-phase reflection | 78 | `### Build-phase reflection` in those files |
